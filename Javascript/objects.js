...
const jsUser = {
    name : "Saikumar",  
    //key in JS object are Bydefault considered as string.
    // Eg name: "Saikumar" is considered as "name" : "Saikumar"
...
console.log(jsUser); 
console.log(jsUser.greeetings());//this will call/execute function in object
